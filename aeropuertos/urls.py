...
from aeropuertos.views import navegacion_dashboard_aeropuertos, agregar_add_aeropuertos, eliminar_delete_aeropuerto, editar_edit_aeropuerto


urlpatterns = [
    # Principal Route/ Ruta principal
    path('', navegacion_dashboard_aeropuertos, name = 'dashboard_aeropuertos'),
    path('agregar_aeropuerto/', agregar_add_aeropuertos , name = 'add_aeropuertos'),
